...
civilServantRegistry.getOrganisation.resolves([testOrg])
...
const assertCreateCourseRecord = (expectedRequired: boolean, expectedCourseState: RecordState,
    expectedModuleState: RecordState, expectedPreference?: string) => {
...
describe('Tests for the event action workers', () => {
    ...
    describe('Tests for the approve booking action worker', () => {
        ...
        it('Should correctly create a course record', async () => {
            ...
            const worker = new ApproveBookingActionWorker(learningCatalogue as any, civilServantRegistry as any, learnerRecordAPI as any)
    ...
    describe('Tests for the cancel booking action worker', () => {
        ...
        it('Should correctly create a course record', async () => {
            learnerRecordAPI.getCourseRecord.resolves(undefined)
            const worker = new CancelBookingActionWorker(learningCatalogue as any, civilServantRegistry as any, learnerRecordAPI as any)
            await worker.applyActionToLearnerRecord(testUserID, testCourseID, testModuleID, testEventID)
