...
export class OrganisationalUnitClient {
	...
	async removeDomain(organisationalUnitId: number, domainId: number) {
        const response = await this._http.delete(`${this.BASE_URL}/${organisationalUnitId}/domains/${domainId}`)
