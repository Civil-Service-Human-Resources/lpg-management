import {MinimalChartJsConfig} from './model/chartjsConfig'
...
export class ChartService {
	...
	buildChart(startDate: string, endDate: string, rawData: DataPoint[]): MinimalChartJsConfig {
		return new MinimalChartJsConfig(startDate, endDate, rawData)
	}
	...
	// 	}))
	// 	const convertedData = labels.slice(0, labels.length-1)
	// 		.map(l => {
	// 		let x = l
	// 		let y = 0
